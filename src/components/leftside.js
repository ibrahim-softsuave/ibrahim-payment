                ...
                <div className='review'>
                    ...
                    <div className='review-container'>
                        <div className='container-items item1'>
                            <p>Executed from:</p>
                            <p>{user.auth.account_no}</p>
                            <p>{formData.amount}{formData.amount_type}</p>
                        </div>
                        <div className='container-items item1'>
                            <p>Charge by:</p>
                            <p>Paide by company</p>
                            <p>110THB</p>
                        </div>
                        <div className='container-items item1'>
                            <p>Payment Reason</p>
                    ...
                    <div className='review-footer'>
                        <div className='footer-items'>
                            <a href="/payment-form">cancel</a>
                            <button onClick={handleBack}>Edit Payment Details </button>
                            <button onClick={handleBack}>Save as Draft </button>
                            <button type='Submit' onClick={handlePopUp}>Submit</button>
                        </div>
                    </div>
                </div>
